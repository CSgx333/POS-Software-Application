...
public class GetProduct3 extends javax.swing.JFrame {
    ...
    public void Search(){
        ...
        int rec=0;
         ...
         String[] head = {"ID", "Name", "SupplierID", "Price"};
         int count=0;
         r.first();  
         datatable[count][0] = r.getString("p_id");
         datatable[count][1] =r.getString("p_name");
         datatable[count][2] =r.getString("sp_id");
         datatable[count][3] =r.getString("price");
         count++;
         while (r.next()){
             datatable[count][0] = r.getString("p_id");
             datatable[count][1] =r.getString("p_name");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        String p_id = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
        String p_name = jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString();
        String sp_id = jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString();
        String price = jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString();
        AddSupplier.jTextField2.setText(p_id);
        AddSupplier.jTextField3.setText(p_name);
        AddSupplier.jTextField4.setText(sp_id);
        AddSupplier.jTextField5.setText(price);
        this.dispose();
