...
public class Stock extends javax.swing.JFrame {
    ...
    public void Search(){
        try{
         ...
         r = s.executeQuery("Select * from stock where st_id="+Integer.parseInt(search.getText()));
        int rec=0;
         while(r.next()){
             rec++;
         }
         ...
         int count=0;
         r.first();  
         datatable[count][0] = r.getString("st_id");
         ...
         datatable[count][6] =r.getString("amount");
         count++;
         while (r.next()){
             datatable[count][0] = r.getString("st_id");
            datatable[count][1] =r.getString("p_id");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, 147, 900, 430));
