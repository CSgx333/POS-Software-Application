...
public class GetGroup extends javax.swing.JFrame {
    ...
    public void Search(){
        try{
         ...
         r = s.executeQuery("Select * from productgroup where g_id="+Integer.parseInt(search.getText()));
        int rec=0;
         while(r.next()){
             rec++;
         }
         ...
         int count=0;
         r.first();  
         datatable[count][0] = r.getString("g_id");
         datatable[count][1] =r.getString("g_name");
         count++;
         while (r.next()){
             datatable[count][0] = r.getString("g_id");
             datatable[count][1] =r.getString("g_name");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        String g_id= jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
        AddProduct.jTextField3.setText(g_id);
        this.dispose();
