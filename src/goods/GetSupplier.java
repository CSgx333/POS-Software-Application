...
public class GetSupplier extends javax.swing.JFrame {
    ...
    public void Search(){
        try{
         ...
         r = s.executeQuery("Select * from supplier where sp_id="+Integer.parseInt(search.getText()));
        int rec=0;
         while(r.next()){
             rec++;
         }
         ...
         int count=0;
         r.first();  
         datatable[count][0] = r.getString("sp_id");
         datatable[count][1] =r.getString("sp_name");
         count++;
         while (r.next()){
             datatable[count][0] = r.getString("sp_id");
             datatable[count][1] =r.getString("sp_name");
    ...
    private void initComponents() {
        ...
        jLabel43.setText("SupplierID");
        jPanel16.add(jLabel43, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, -1, 20));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        String sp_id= jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
        AddProduct.jTextField5.setText(sp_id);
        this.dispose();
