...
public class GetSubGroup extends javax.swing.JFrame {
    ...
    public void Search(){
        try{
         ...
         r = s.executeQuery("Select * from subgroup where s_id="+Integer.parseInt(search.getText()));
        int rec=0;
         while(r.next()){
             rec++;
         }
         ...
         int count=0;
         r.first();  
         datatable[count][0] = r.getString("s_id");
         datatable[count][1] =r.getString("s_name");
         count++;
         while (r.next()){
             datatable[count][0] = r.getString("s_id");
             datatable[count][1] =r.getString("s_name");
    ...
    private void initComponents() {
        ...
        jLabel43.setText("SubGroupID");
        jPanel16.add(jLabel43, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, -1, 20));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        AddProduct.jTextField4.setText(s_id);
        this.dispose();
